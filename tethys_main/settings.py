...
DATABASES = {
    'default': {
        ...
        'NAME': 'tethys_default',
        'USER': 'tethys_default',
        'PASSWORD': os.environ['TETHYS_DEFAULT_PASS'],
        'HOST': os.environ['POSTGIS_CONTAINER_NAME'],
        'PORT': '5432'
    }
}
...
TETHYS_DATABASES = {
    'tethys_db_manager': {
        ...
        'PASSWORD': os.environ['TETHYS_DB_MANAGER_PASS'],
        'HOST': os.environ['POSTGIS_CONTAINER_NAME'],
        'PORT': '5432'
    },
    'tethys_super': {
        'NAME': 'tethys_super',
        'USER': 'tethys_super',
        'PASSWORD': os.environ['TETHYS_SUPER_PASS'],
        'HOST': os.environ['POSTGIS_CONTAINER_NAME'],
        'PORT': '5432'
    }
}
