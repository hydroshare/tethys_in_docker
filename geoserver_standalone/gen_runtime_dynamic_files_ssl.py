...
def gen_nginx(num_enabled_nodes, num_rest_nodes, default_http_port):
    ...
    # set ports ans server_name
    server_name = os.environ.get('SERVER_NAME', 'localhost')
    port_ssl_internal = os.environ.get('PORT_SSL_INTERNAL', '8443')
    port_ssl_external = os.environ.get('PORT_SSL_EXTERNAL', '8443')
    context["server_name"]=server_name
    context["port_ssl_internal"] = port_ssl_internal
    context["port_ssl_external"] = port_ssl_external
    ...
    render_and_write_to_file(context=context, template='geoserver_ssl_template.conf', filename=nginx_config)
